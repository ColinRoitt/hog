...
function advanceRound(room, questions, onStateChange) {
  ...
  game.currentRound = {
    ...
    correctAnswer: Number(pickedQuestion.question.answer),
    guesses: {},
    teamAAverage: null,
    teamBAverage: null,
    winningTeams: [],
...
function startGame(room, questions, onStateChange) {
  ...
  if (connectedPlayers.length < 4) {
    return { error: "Distinctly Average needs at least 4 connected players." };
  }
